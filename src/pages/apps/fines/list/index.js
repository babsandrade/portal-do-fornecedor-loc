...
import { columns } from '../../../../views/apps/fines/list/columns'
          ...
          <Card>
            ...
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
              <FilterMenu anchorEl={anchorEl} handleClose={handleClose} handleClick={handleClick}>
                ...
                <Grid item xs={12} sm={12}>
                  <CustomTextField fullWidth label='Tipo de Multa' placeholder='Tipo de Multa' value={value} />
                </Grid>
                <Grid item xs={12} sm={12}>
