  ...
  return (
    <DatePickerWrapper>
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <MainHeader title='Frota' />{' '}
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: '8px' }}>
              <FilterMenu anchorEl={anchorEl} handleClose={handleClose} handleClick={handleClick}>
                <Grid item xs={12} sm={12}>
                  <CustomTextField fullWidth label='Tipo de Frota' placeholder='Tipo de Frota' value={value} />
                </Grid>
                <Grid item xs={12} sm={12}>
                ...
                <Grid item xs={12} sm={12}>
                  <DatePicker
                    ...
                    placeholderText='Período de Abertura'
                    customInput={
                      <CustomInput
                ...
                <Grid item xs={12} sm={12}>
                  <DatePicker
                    ...
                    id='date-range-picker-months'
                    onChange={handleOnChangeRange}
                    placeholderText='Período de Retorno '
                    customInput={
                      <CustomInput
              ...
              <Button variant='tonal' color='primary' aria-haspopup='true'>
                <Icon icon='tabler:file-arrow-right' /> Exportar
              </Button>
            </div>
          </Card>
        </Grid>
