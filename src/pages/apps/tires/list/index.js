...
import { columns } from 'src/views/apps/tires/list/columns'
  ...
  return (
    <DatePickerWrapper>
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <MainHeader title='Pneus' addButtonIcon='plus' addButtonHref='/apps/invoice/add' />{' '}
            <FilterMenu anchorEl={anchorEl} handleClose={handleClose} handleClick={handleClick}>
              ...
              <Grid item xs={12} sm={12}>
                <DatePicker
                  ...
                  placeholderText='Data de Atualização KM'
                  customInput={
                    <CustomInput
              ...
              <Grid item xs={12} sm={12}>
                <DatePicker
                  ...
                  id='date-range-picker-months'
                  onChange={handleOnChangeRange}
                  placeholderText='Data de abertura da OS'
                  customInput={
                    <CustomInput
