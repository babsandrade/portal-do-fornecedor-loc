...
import { columns } from 'src/views/apps/notifications/list/columns'
  ...
  return (
    <DatePickerWrapper>
      <Grid container spacing={6}>
        <Grid item xs={12}>
          <Card>
            <MainHeader title='Notificações' addButtonIcon='plus' addButtonHref='/apps/invoice/add' />{' '}
            <FilterMenu anchorEl={anchorEl} handleClose={handleClose} handleClick={handleClick}>
              <Grid item xs={12} sm={12}>
                <CustomTextField label='Código do Serviço' fullWidth placeholder='Código do Serviço' value={value} />
              </Grid>
              <Grid item xs={12} sm={12}>
