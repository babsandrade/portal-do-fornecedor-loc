...
import OverviewBarChartService from './OverviewBarChartService'
import OverviewLineChartService from './OverviewLineChartService'
import OverviewPieChartService from './OverviewPieChartService'

const tabData = [
  {
    type: 'Anual',
    avatarIcon: 'tabler:chart-bar',
    chart: <OverviewBarChartService />
  },
  {
    type: 'Tendência',
    avatarIcon: 'tabler:chart-histogram',
    chart: <OverviewLineChartService />
  },
  {
    type: 'Mensal',
    avatarIcon: 'tabler:chart-pie-2',
    chart: <OverviewPieChartService />
  }
]
...
const OverviewChartService = () => {
  ...
  return (
    <Card>
      <CardHeader title='Visão Geral dos Serviços' />
...
export default OverviewChartService
